            ...
            <div class="footer-grid">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="<?php echo home_url('/properties'); ?>" class="footer-link">Featured Listings</a></li>
                        ...
                        <li><a href="<?php echo home_url('/terms'); ?>" class="footer-link">Terms & Conditions</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="#" class="footer-link">Apartments</a></li>
                        <li><a href="#" class="footer-link">Villas</a></li>
                        <li><a href="#" class="footer-link">Land</a></li>
                        <li><a href="#" class="footer-link">Office Space</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-contact">
                        <li class="contact-item">
                            ...
                            <span>123 Real Estate Street<br>Chennai, Tamil Nadu 600001</span>
                        </li>
                        <li class="contact-item">
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328z"/>
                            </svg>
                            <span>+91 9962214714</span>
                        </li>
                        <li class="contact-item">
                            <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="container">
            <div class="footer-bottom-content">
                ...
                <p class="developer-credit">
                    Developed by <a href="https://itspaxiosinnovation.in" target="_blank" rel="noopener">IT Spaxios Innovation</a>
                </p>
            </div>
        </div>
    </div>
